...
function OrderSuccessPage() {
  ...
  return (
    <>
      ...
      <main className="grid min-h-full place-items-center bg-white px-4 py-16 sm:px-6 sm:py-32 lg:px-8">
        <div className="text-center">
          <p className="text-base font-semibold text-indigo-600">
            Order Successfully Placed
          </p>
          <h1 className="mt-4 text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl lg:text-5xl">
