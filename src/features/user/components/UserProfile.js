        ...
        <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
          ...
          {userInfo.addresses.map((address, index) => (
            <div key={index}>
              ...
              <div className="flex flex-col sm:flex-row justify-between gap-2 sm:gap-x-6 px-5 py-5 border-solid border-2 border-gray-200">
                ...
                <div className="flex flex-row sm:flex-col gap-4 sm:gap-2 sm:mt-0 sm:items-end">
                  <button
